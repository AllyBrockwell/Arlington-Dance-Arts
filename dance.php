...
>>>>>>> 992ca97101e3e9fb47082203f8db57ccb166c452:dance.php
    ...
    <div class = "dance">
        ...
        <div class = "name"><p><a name ="creative"><b>Creative Movement</b> (2 1⁄2 to 3 1⁄2 year olds):</div>
        ...
        <div class = "name"><p><a name ="kinder"><b>Kindermovement I and II</b> (Ages 4-6 year olds):</div>
        Children learn rhythm, movement, and shapes their body can make in this fun class. Children
        enrolled in this class will cover the basics of Ballet, the listening and learning of Tap, and get an
         introduction to Tumbling. 1 hour class $55.00 per month</a></p><br>

            <img id="recital" src="pictures/recital.jpg" alt = "recital">

      <div class = "name">  <p><a name ="kids"><b>Kids Dance I, II, and III</b> (Ages 6-10 year olds):</div>
      ...
      <div class = "name">  <p><a name ="junior"><b>Junior and Senior Dancers</b> (11 years to young adults):</div>
        This group of dancers is comprised of many different levels. We will encourage skills and natural>
         abilities in dance while continuing to develop the dancers technique and capabilities in Ballet,
         Tap, and Jazz. Specific attention will be paid to lengthening and strengthening muscles to meet the
         demands of dance. 2 hour class $80.00 per month</a></p><br>

            <img id="me" src="pictures/me.jpg" alt ="me">

        <div class = "name"> <p><a name ="ballet"><b>Ballet Extended</b> (Ages 7 and up):</div>
        ...
        <div class = "name"><p><a name ="hip"><b>Hip Hop</b> (Ages 6 and up):</div>
        Fun, fast and edgy. This class incorporates great warm ups with the quick and stylish moves of hip
        hop dance. Classes is broken into age categories.  45 minute class $50.00 per month -  1 hour class
        $55.00 per month</a> </p><br>

      <div class = "name">  <p><a name ="ballroom"><b>Ballroom: </b></div>
